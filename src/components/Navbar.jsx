    ...
    return (
        <nav className="flex justify-between items-center py-4 mb-6 border-b border-gray-800 relative">
            ...
            <div className="flex items-center gap-5">
                    ...
                    {showNotifications && (
                        <div className="absolute right-0 top-8 mt-2 w-72 bg-cardbg border border-gray-800 rounded-xl shadow-2xl z-50 overflow-hidden">
                            <div className="px-4 py-3 border-b border-gray-800 flex justify-between items-center">
                                ...
                                <span className="text-xs text-[#0ea5e9] cursor-pointer hover:underline">Clear all</span>
                            </div>
                ...
                {/* 4. Devices / Microchip */}
                <button className="hidden lg:flex items-center gap-1.5 text-gray-400 hover:text-white transition-colors font-medium text-sm ml-2">
                    <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                {/* 5. Bill / Receipt */}
                <button className="hidden lg:flex items-center gap-1.5 text-gray-400 hover:text-white transition-colors font-medium text-sm">
                    <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
